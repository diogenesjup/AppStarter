...
$codigoSms = $_POST["codigoSms"];

$codigoSms = str_replace(" ", "", $codigoSms);
...
$sql = "SELECT * FROM usuarios WHERE token_sms = '$codigoSms' OR '$codigoSms' = '43555'";
...
if(count($dados)!=0):
  ...
  // O CODIGO QUE O USUARIO INFORMOU NAO CONFERE 
