...
if($token=="F9803B518FD8E8E0CD0E7E51F164B7463BDFBC5337DB8603A7B78FFAD76FDFA8"):
     ...
     $sql = "INSERT INTO clientes(nome, cpf, cnpj, email, celular, telefone, senha, data_cadastro, endereco, cep, bairro, cidade, estado, id_corretor, observacoes) VALUES(:nome, :cpf, :cnpj, :email, :celular, :telefone, :senha, :data_cadastro, :endereco, :cep, :bairro, :cidade, :estado, :id_corretor, :observacoes)";
