...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue("F1", "FORMA PAGAMENTO + VALOR" )
...
$objPHPExcel->getActiveSheet()->getColumnDimension('F')->setWidth(30);
 ...
 $sql = "SELECT t1.id,
                   ...
                   t2.meio_pagamento,
                   t3.id_usuario AS id_rd
                   FROM usuarios AS t1 JOIN inscritos AS t2 JOIN publicacoes AS t3
                                        ON t1.email = t2.email AND t2.id_evento = '$id_evento' AND t3.id_usuario = t1.id
...
while($i<$tot_dados):
    ...
    $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(4, $linhaEx, $dados[$i]["status_transacao"]);
    $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(5, $linhaEx, $dados[$i]["meio_pagamento"]." ".$dados[$i]["ingresso_pago"]);
    $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(6, $linhaEx, $dados[$i]["numero_tel"]);
